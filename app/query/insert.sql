...
INSERT INTO water_bills (user_id, prev_volume, cur_volume, total_volume, price, total_volume_price, due_date, payment_date, created_at)
VALUES
    (1, 100, 120, 20, 1000, 20000, '2024-04-30', '2024-04-20', NOW() - INTERVAL '1 day'),
    (2, 80, 110, 30, 2000, 60000, '2024-05-01', '2024-04-21', NOW() - INTERVAL '2 day'),
    (3, 150, 180, 30, 2000, 60000, '2024-05-02', '2024-04-22', NOW() - INTERVAL '3 day'),
    (4, 70, 90, 20, 1000, 20000, '2024-05-03', '2024-04-23', NOW() - INTERVAL '4 day'),
    (5, 120, 150, 30, 2000, 60000, '2024-05-04', '2024-04-24', NOW() - INTERVAL '5 day'),
    (6, 50, 80, 30, 2000, 60000, '2024-05-05', '2024-04-25', NOW() - INTERVAL '6 day'),
    (7, 110, 140, 30, 2000, 60000, '2024-05-06', '2024-04-26', NOW() - INTERVAL '7 day'),
    (8, 90, 120, 30, 2000, 60000, '2024-05-07', '2024-04-27', NOW() - INTERVAL '8 day'),
    (9, 130, 160, 30, 2000, 60000, '2024-05-08', '2024-04-28', NOW() - INTERVAL '9 day'),
    (10, 100, 130, 30, 2000, 60000, '2024-05-09', '2024-04-29', NOW() - INTERVAL '10 day');
